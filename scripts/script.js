...
function printMedia(sortedDatabase) {
	...
	globalPlayer.leftSongs.style.visibility = 'hidden';
	...
	setTimeout(()=>{
		globalPlayer.leftSongs.querySelectorAll('.container.albumArt').forEach(e=>{
		...
		globalPlayer.leftSongs.style.visibility = 'visible';
	},500);
}
